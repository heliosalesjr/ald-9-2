    ...
    return (
      <div className="bg-slate-600 pb-8">
        ...
        <div className="max-w-2xl mx-auto p-4">
            ...
            <h1 className="text-center font-bold text-4xl text-white pt-8">Comparando os Ciclos de Projeto</h1>
            <p className="text-white p-8 text-center">Acompanhando nossa linha do tempo, verificamos então as atividades a serem executadas nesta fase marcados com uma cor mais escura:</p>
            ...
            <div className="bg-blue-500 p-4 rounded">
                <p className="text-center text-white flex items-center justify-center h-full font-semibold">Montagem do Plano de Ação</p>
            </div>

            <div className="bg-orange-400 p-4 rounded">
                <p className="text-center text-white flex items-center justify-center h-full font-semibold">Montagem do Planejamento Didático Ativo</p>
            </div>
            <div>
            </div>
            
            <div className="bg-orange-400 p-4 rounded">
                <p className="text-center text-white flex items-center justify-center h-full font-semibold">Execução das atividades</p>
            </div>
            <div className="bg-blue-500 p-4 rounded">
                <p className="text-center text-white flex items-center justify-center h-full font-semibold">Execução das atividades</p>
            </div>
